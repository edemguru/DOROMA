...
public interface ITcpControllerClientCli {

	// --- Remote (logged-in) client commands needed for Lab 1 ---
	...
	/**
	 * Show usage information of remote (logged-in) available commands.
	 * <p/>
	 * E.g.:
	 * 
	 * <pre>
