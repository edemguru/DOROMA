...
public class ComponentFactory {
	...
	public IClientCli createClient(String componentName, TestInputStream in,
		...
		return new Client(componentName, config, in, out, out);
	}

	public IClientCli createClient(String componentName, TestInputStream in,
			TestOutputStream out, TestOutputStream err) throws Exception {
		/*
		 * TODO: Here you can do anything in order to construct a node instance.
		 * Depending on your code you might want to modify the following lines
		 * but you do not have to.
		 */
		Config config = new Config("client");
		return new Client(componentName, config, in, out, err);
	}
	...
	public ICloudControllerCli createCloudController(String componentName,
		...
		return new CloudController(componentName, config, in, out, out);
	}
	public ICloudControllerCli createCloudController(String componentName,
			TestInputStream in, TestOutputStream out, TestOutputStream err) throws Exception {
		/*
		 * TODO: Here you can do anything in order to construct a node instance.
		 * Depending on your code you might want to modify the following lines
		 * but you do not have to.
		 */
		Config config = new Config("controller");
		return new CloudController(componentName, config, in, out, err);
	}
	...
	public INodeCli createNode(String componentName, TestInputStream in,
		...
		return new Node(componentName, config, in, out, out);
	}
	public INodeCli createNode(String componentName, TestInputStream in,
			TestOutputStream out, TestOutputStream err) throws Exception {
		/*
		 ...
		 */
		Config config = new Config(componentName);
		return new Node(componentName, config, in, out, err);
	}
